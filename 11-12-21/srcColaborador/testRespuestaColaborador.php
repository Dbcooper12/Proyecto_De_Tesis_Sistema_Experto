...
<?php 
    ...
    try{ 
            ...
            $iduser=$_GET['id']; 
            $objTest = new Test();
            $lista_preguntas = $objTest->obtenerTestColaborador($iduser); 
            ...
            <div class="contenedor_tabla" style= "align-items: center;text-align: center;" > 
                    ...
                    <div class="contenedor_tabla" style= "align-items: center;text-align: center;">                          
                          ...
                          <h1><?php echo ($i+1) . '.' . $lista_preguntas[$i]['descripcion'];?></h1> <br> <br>
                            ...
                            <input type="hidden" name="cod_pregunta_alumno<?php echo ($i+1)?>" value="<?php echo $lista_preguntas[$i]['factor_riesgo_cod_factor_riesgo']?>">
                            <?php 
                              if($lista_preguntas[$i]['factor_riesgo_cod_factor_riesgo']=='1'){
                                ?>

                               <div class="radiosP">  <span>Respuesta: Si</span>  <br></div>
                                <?php
                              }
                              if($lista_preguntas[$i]['factor_riesgo_cod_factor_riesgo']=='2'){
                                ?>
                               <div class="radiosP">   <span>Respuesta: No</span>  <br></div>
                                <?php
                              } 
                            ?> 
                            </div>
