 ...
 <header>
        ...
        ?>
                ...
                ?>  
                    ...
                    <div>                                            
                        <table >
                            <td> </td>
                                <td> 
                                <form role = 'form' method="post" class="form_search">
             ...
             <div class="contenedor_tablaD">
                    <div class="contenedor_titulo">
                   <center> <a class ="link_edit"  href="excel.php?id=<?php  echo $iduser ?>&grado=<?php  echo $grado ?>&estado=<?php  echo $estadoTabla ?>"><img src="https://cdn-icons-png.flaticon.com/512/888/888850.png" alt="información" style="width: 20px;height: 20px;">Exportar</a> </center>
                    </div>
                    </div>
             <?php 
