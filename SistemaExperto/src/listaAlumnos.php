    ...
    <p>
			...
			<nav class="menu"> 
             ...
             <table  >
                 ...
                 $sql_registro = mysqli_query($conexion,"SELECT COUNT(*) as total FROM alumnos");
                 ...
                 $sql="SELECT ID_Alumnos,nombres,apellidos,dni,edad,grado,sexo,estado FROM alumnos LIMIT $desde,$por_pag";
             ...
             <div class="paginador" >
                 ...
                 ?>   
                 <li><a href="?pagina=<?php echo 1; ?>" style=" color: #428bca; border: 1px solid #ddd;padding: 5px;display: inline-block;font-size: 14px;text-align: center;width: 35px;">|<<</a> </li>
                     <li><a href="?pagina=<?php echo $pagina-1; ?>"style=" color: #428bca; border: 1px solid #ddd;padding: 5px;display: inline-block;font-size: 14px;text-align: center;width: 35px;"><<<</a> </li>
                   <?php }
                   ?>
                   ...
                   <?php
                     for($i=1; $i <=$total_paginas; $i++){
                         if($i==$pagina){
                            ...
                            echo '<li><a href="?pagina='.$i.'" style=" color: #428bca; border: 1px solid #ddd;padding: 5px;display: inline-block;font-size: 14px;text-align: center;width: 35px;">'.$i.'</a> </li> ';
                      }
                     ...
                     if($pagina !=$total_paginas){
                      ...
                      ?> 
                     <li><a href="?pagina=<?php echo $pagina+1; ?>"style=" color: #428bca; border: 1px solid #ddd;padding: 5px;display: inline-block;font-size: 14px;text-align: center;width: 35px;">>>></a> </li>
                     <li><a href="?pagina=<?php echo $total_paginas; ?>"style=" color: #428bca; border: 1px solid #ddd;padding: 5px;display: inline-block;font-size: 14px;text-align: center;width: 35px;">>>|</a> </li>
                        <?php }?>
                    </ul>
             </div>
